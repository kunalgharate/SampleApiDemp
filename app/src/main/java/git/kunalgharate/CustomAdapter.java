...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> implements Filterable {
    ...
    private ArrayList<ApiData.IssueQuestionDatum> userList;
    private ArrayList<ApiData.IssueQuestionDatum> filteredUserList;
    private Context context;
    private CustomItemClickListener customItemClickListener;

    public CustomAdapter(Context context,ArrayList<ApiData.IssueQuestionDatum> userArrayList,CustomItemClickListener customItemClickListener) {
    ...
    public void onBindViewHolder(CustomAdapter.MyViewHolder viewHolder, int position) {
       ...
       viewHolder.userId.setText(filteredUserList.get(position).getIssueName());
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (searchString.isEmpty()) {
                    ...
                    ArrayList<ApiData.IssueQuestionDatum> tempFilteredList = new ArrayList<>();

                    for (ApiData.IssueQuestionDatum apiData : userList) {

                        // search for apiData title
                       if (apiData.getIssueName().toLowerCase().contains(searchString)) {

                            tempFilteredList.add(apiData);
                        }
                    }
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                filteredUserList = (ArrayList<ApiData.IssueQuestionDatum>) filterResults.values;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View view) {
            super(view);
          userId = (TextView)view.findViewById(R.id.text);
